...
contract CrpPollRoadmap is CrpInfc {    
    ...
    uint256 public voter_count; // 투표자 수
    ...
    address public last; // 투표 꼐좌 체인 꼬리

    // private variable    
    string constant contract_type = "POLLROAD";
    ...
    /// @author sykang
    /// @notice the constructor of crpRoadmapPoll contract    
