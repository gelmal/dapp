...
let input_params = fs.readFileSync(args_dir + '/scn6_JoinPollRoadmap.json', 'utf8');
...
/**
 * roadmap poll을 실행하는 함수이다.
 * 1. unlock Account 수행
 * 2. 표 분류
 * 3. roadmap contract의 polling
...
let pollRoad = async () => {
    try {
        ...
        console.log("poll of roadmap by holder ....."); // 투표
